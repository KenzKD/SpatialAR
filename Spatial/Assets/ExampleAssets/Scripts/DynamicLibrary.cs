...
namespace UnityEngine.XR.ARFoundation.Samples
{
    ...
    public class DynamicLibrary : MonoBehaviour
    {
        ...
        [SerializeField] XRReferenceImageLibrary XRLibrary;
        void Update()
        {
            switch (m_State)
            {
                case State.AddImagesRequested:
                    {
                        ...
                        //XRReferenceImageLibrary serializedLibrary = GetComponent<XRReferenceImageLibrary>();
                        //RuntimeReferenceImageLibrary runtimeLibrary = manager.CreateRuntimeLibrary(manager.);
                        if (manager == null)
                        {
                        ...
                        if (manager.CreateRuntimeLibrary(XRLibrary) is MutableRuntimeReferenceImageLibrary mutableLibrary)
                        {
